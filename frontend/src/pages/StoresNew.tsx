...
const formatStoreForUI = (store: Store) => ({
  ...
  status: store.isActive ? "Active" as StoreStatus : "Inactive" as StoreStatus,
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatNumber>{loading ? <Spinner size="sm" /> : "Online"}</StatNumber>
              <StatHelpText>
                System status
              </StatHelpText>
            </Stat>
                ...
                <Tr key={store.id}>
                  ...
                  <Td>
                    <VStack align="start" spacing={1}>
                      ...
                      <Text fontSize="sm" color="gray.500">{store.phone}</Text>
                    </VStack>
                  </Td>
                  <Td>
                    <Badge colorScheme={store.status === "Active" ? "green" : "red"}>
                      {store.status}
                    </Badge>
                  </Td>
                  <Td>
              ...
              {filteredStores.length === 0 && !loading && (
                <Tr>
                  <Td colSpan={5} textAlign="center" py={8}>
                    <Text color="gray.500">
                      {stores.length === 0 ? "No stores found. Add your first store!" : "No stores match your filters."}
                    </Text>
                  </Td>
                </Tr>
              )}
