...
const emptyNewProduct: NewProduct = {
  // sku is now auto-generated by backend
  name: "",
  category: "",
  subcategory: "",
  brand: "",
...
const Products: React.FC = () => {
  ...
  const handleInputChange = (
    ...
    if (field === "supplierId" && typeof value === "string") {
      const selectedSupplier = suppliers.find((s) => s.id === value);
      const brand = selectedSupplier ? selectedSupplier.name.split(" ")[0] : "";
      setNewProduct((prev: NewProduct) => ({
        ...prev,
        [field]: value,
        brand: brand, // Auto-populate brand from supplier
      }));
    } else {
      setNewProduct((prev: NewProduct) => ({
        ...prev,
  ...
  const handleCreateProduct = async () => {
    try {
      ...
      const createRequest: ProductCreateRequest = {
        ...
        casePackSize: newProduct.casePackSize,
        supplierId: newProduct.supplierId,
        status: newProduct.status,
        // sku is omitted - will be auto-generated by backend
      };

      const response = await productAPI.create(createRequest);
        ...
        <ModalContent>
              ...
              <HStack spacing={4}>
                ...
                <FormControl>
                  ...
                  <Input
                    ...
                    isReadOnly
                    bg="gray.100"
                    placeholder="Auto-populated from supplier"
                  />
                </FormControl>
              </HStack>
          ...
          <ModalFooter>
            ...
            <Button
              ...
              disabled={!newProduct.name || !newProduct.supplierId}
            >
              Create Product
            </Button>
          </ModalFooter>
        ...
        <ModalContent>
                  ...
                  <FormControl isRequired>
                    ...
                    <Select
                      ...
                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                        ...
                        const brand = selectedSupplier
                          ? selectedSupplier.name.split(" ")[0]
                          : "";
                        setEditingProduct({
                          ...editingProduct,
          ...
          <ModalFooter>
            ...
            <Button
              ...
              disabled={!editingProduct?.name || !editingProduct?.supplierId}
            >
              Update Product
            </Button>
          </ModalFooter>
